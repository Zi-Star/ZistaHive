    ...
    <div className="min-h-screen bg-deep-indigo-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70">Sign in to continue earning Honey</p>
        </div>
        ...
        <div className="bg-deep-indigo rounded-2xl shadow-xl p-8 border border-deep-indigo-light/20">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-deep-indigo text-white/60">Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="rounded border-deep-indigo-light/20 bg-deep-indigo-light/10 text-golden-honey focus:ring-golden-honey" />
                <span className="text-white/70">Remember me</span>
              </label>
              <Link href="/forgot-password" className="text-golden-honey hover:text-golden-honey-light font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-white/70">
            ...
            <Link href="/signup" className="text-golden-honey hover:text-golden-honey-light font-semibold">
              Sign up for free
            </Link>
          </p>
        </div>
